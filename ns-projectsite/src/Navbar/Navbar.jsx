        ...
        <div className={`w-full container mx-auto`}>
            <div className="w-full flex items-center justify-between relative">
                ...
                <div className="flex w-1/2 justify-end  flex-row flex-wrap">
                    ...
                    <Link to="/design" className="inline-block text-blue-300 no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out">Design</Link>
                    <a href="/" className="inline-block text-blue-300 no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out">Implementation</a>
                    <a href="/" className="inline-block text-blue-300 no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out">Testing</a>
                    <a href="/" className="inline-block text-blue-300 no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out">Evaluation</a>
                    <a href="/" className=" inline-block text-blue-300 no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out">Appendices</a>
                    <Outlet />
                </div>
            </div>
        </div>
